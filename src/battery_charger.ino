...
int _outputValue = 0;     //value of PWM output signal 
int _old_outputValue = 0;     //value of PWM output signal 
...
float count2 = 0;
float charged = 0;
float checkIfCharged = 2000;
float ChargingDifference;
float chargingVoltageAvg=0;
float currentAvg=0;
float voltageProbeOneAvg = 0;
float voltageProbeTwoAvg = 0;
float voltageProbeThree = 0;
float voltageProbeThreeAvg = 0;
...
// ====================================================================================
float getBatteryVoltage(int __analogPinOne, int __analogPinTwo, int __analogPinThree){
  // ====================================================================================
  ...
  for( int n=0 ; n < _loop1 ; n++ ){
    valueProbeOne      = analogRead(__analogPinOne);    // read the input value at probe one
    voltageProbeOne   += (valueProbeOne/1023);     //calculate voltage at probe one in milliVolts
    valueProbeTwo      = analogRead(__analogPinTwo);    // read the input value at probe two
    voltageProbeTwo   += (valueProbeTwo/1023);     //calculate voltage at probe two in milliVolts
    valueProbeThree    = analogRead(__analogPinThree);    // read the input value at probe three  
...
// ====================================================================================
void loop(){
  chargeBatteryLoop(analogPinOne,analogPinTwo, analogPinThree);
}

// ====================================================================================
void chargeBatteryLoop(int __analogPinOne, int __analogPinTwo, int __analogPinThree){
  // ====================================================================================
  ...
  //  - voltageProbeTwo
  // ====================================================================================
  batteryVoltage = getBatteryVoltage(__analogPinOne, __analogPinTwo, __analogPinThree);
  ...
  // ====================================================================================
    ...
    if ( count2 >= _loop2 ) {
      ...
      */
      ...
      // ====================================================================================
      float batteryVoltageAvg=0;
      float limitCheckIfCharged =  ( _checkCharge / _loop2 ) / ( 1 + charged * 10 ) ;
      int n=0;
